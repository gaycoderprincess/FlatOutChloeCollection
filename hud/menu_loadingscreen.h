...
public:
	...
	static inline tLoadingScreenTip aTips[] = {
			...
			//{"CRASH BONUS:", "SUPER FLIP", "Smash into a car and toss it onto its roof to get the Super Flip bonus. Subsequent flips in the crash are not rewarded."},
			{"CRASH BONUS:", "SUPER FLIP", "Smash into a car and toss it onto its roof to get the Super Flip bonus."},
			{"CRASH BONUS:", "SLAM, POWERHIT, BLAST-OUT", "Dish out a high power impact to a car for a hit bonus. Hit bonuses range from Slam (lowest) to Blast-Out (highest)."},
			...
			{"RAGDOLL STUNTS: ", "USE ANY CONTROLLER IN PARTY MODE", "Any controller that is plugged in can be used in Party Mode. However, the controller used cannot be changed during gameplay."},
	...
	static inline tLoadingScreenTip aRaceTips[] = {
			...
			{"TOP DRIVERS: ", "TOP DRIVERS: BLAST MASTER", "Deal out the hardest hits and get the most Blast-Out bonuses to show that you are the ultimate Blast Master!"},
			...
			{"RESETTING: ", "RESET BUTTON", "If you flip your car, crash, come off the track, or your driver crashes through the windshield, press the RESET button to reset your position back on the track with a rolling start."},
			{"RESETTING: ", "RESET OFTEN", "If you drive out of the track, crash badly or drive slow enough, use the brake to stop and press the RESET button. This is often much faster than trying to drive back."},
			{"RAGDOLLING:", "WINDSHIELD CRASHES", "Big crashes can cause driver Crash-Out's, where the driver is thrown through the windshield. To decrease the chances of Crash-Out's, upgrade the strength of your car."},
			{"DRIVING TIPS:", "POWERSLIDE", "Release acceleration, turn and reapply acceleration to powerslide. Powersliding enables you to maintain your speed and momentum and drive FlatOut!"},
			{"DRIVING TIPS:", "NITRO CORNERING", "Use the nitro to keep your car on the road during tight cornering. This will allow you to corner at speeds not normally possible and recover from coming into a corner too fast."},
			{"DRIVING TIPS:", "HUG THE CORNERS", "Hug the inside of corners to maintain maximum speed when taking consecutive turns."},
			{"DRIVING TIPS:", "USE THE BRAKE!", "Learn to brake at the right time without losing too much speed. Sometimes it's faster to brake before a corner than to drive it flat out. Applying the brakes midair helps to lose the speed efficiently after landing."},
			{"DRIVING TIPS:", "FAST START", "For the best start avoid full acceleration. Instead, use around 30-50% acceleration during the countdown before flooring the pedal."},
			{"DRIVING TIPS:", "HIT 'EM HIGH", "Use other cars as impact absorbers when crashing into obstacles. Slam into other cars to take corners at higher speeds."},
			{"DRIVING TIPS:", "SOMEBODY TO LEAN ON", "Use the terrain to your advantage! Lean on your opponents to keep them from overtaking you or simply shove them into the nearest tree!"},
	};

	static inline tLoadingScreenTip aDerbyTips[] = {
			{"DERBIES:", "GO FOR POWERFUL HITS", "Get maximum velocity relative to your target before you hit. The higher your speed, the more damage inflicted."},
	};
	...
	static inline tLoadingScreenTip aWreckingDerbyTips[] = {
			...
			{"DERBIES:", "TACTICS", "There are multiple ways to win the derby. You get points for damage done, kills and surviving to the final three. Although you get bonus points for being in the last three, this isn't always necessary if you've dealt out loads of damage."},
	};

	static inline tLoadingScreenTip aBeatTheBombTips[] = {
			{"BEAT THE BOMB:", "EVERY SECOND COUNTS", "Checkpoint times are added to the time you have left. Thus every second counts. Cutting a second or two in the beginning of the run will give you those few seconds more in the end of the run."},
			{"BEAT THE BOMB:", "COLLECT NITRO", "Maximize nitro gain during the run. Crash into scenery and find the big jumps. Use nitro to jump further and gain more nitro. Don’t overcollect! If your tank is full, save some nitro gathering places for the second lap."},
			{"BEAT THE BOMB:", "TACTICAL NITRO USAGE", "Burn nitro before long straights to get the maximum benefits. Make sure tires touch the ground when you use nitro. Watch out for overburn. If your speed is already maxed, there’s no point in wasting more nitro."},
	};

	static inline tLoadingScreenTip aTimeTrialTips[] = {
			{"TIME TRIAL:", "OPTIMAL RACELINES", "Stay on the optimal racelines to improve your time. Plan ahead your route, cut corners and choose lines that help you retain your speed."},
			{"TIME TRIAL:", "OPTIMAL SPEED", "Retain the optimal speed. Remember that there’s no nitro to help you, so retaining the speed all the time is crucial."},
			{"TIME TRIAL:", "FIND SHORTCUTS", "The road isn’t always the fastest route. Find shortcuts and use them, but make sure that they don’t slow you down too much."},
	};

	static inline tLoadingScreenTip aArcadeRaceTips[] = {
			{"ARCADE RACE:", "CRASH 'EM ALL", "Crash into other cars to improve your score. Wrecking other cars yields big scores, but even small crash bonuses yield some score."},
			...
			//{"ARCADE RACE:", "STAY IN THE LEAD", "Stay in the lead to get 5x position bonus. 2nd and 3rd places give 4x score, 4th-6th 3x, 7th-9th 2x and 10th-12th 1x score."},
			...
			{"ARCADE RACE:", "TIME IS OF THE ESSENCE", "Squeeze the last bits of score by passing as many checkpoints as possible. You’ll get score from each check point, and bonus time for passing them."},
	};
	...
	static inline tLoadingScreenTip aFragDerbyTips[] = {
			...
			{"FRAG DERBY:", "FRAG STREAK", "Get more frags without getting wrecked than anyone else to get on a Frag Streak! While on streak, you score double for each kill."},
			{"FRAG DERBY:", "SURVIVOR", "Avoid getting fragged for the longest time to become the Survivor! While surviving, you earn bonus points for the time you survive."},
			...
			{"FRAG DERBY:", "TACTICS", "Target players with Frag Streak or Survivor. This steals the score bonuses from them, and makes it easier for you to get the bonus status."},
	...
	tDrawPositions1080p gLoadingTipText = {960,760,0.03};
