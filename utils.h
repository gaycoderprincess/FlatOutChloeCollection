...
int FO2ToNyaControllerKey(int key) {
	switch (key) {
		...
		case CONTROLLER_BUTTON_UP: return NYA_PAD_KEY_LSTICK_Y_POS;
		case CONTROLLER_BUTTON_DOWN: return NYA_PAD_KEY_LSTICK_Y_NEG;
		case CONTROLLER_BUTTON_LEFT: return NYA_PAD_KEY_LSTICK_X_NEG;
		case CONTROLLER_BUTTON_RIGHT: return NYA_PAD_KEY_LSTICK_X_POS;
		case CONTROLLER_BUTTON_RIGHT_UP: return NYA_PAD_KEY_RSTICK_Y_POS;
		case CONTROLLER_BUTTON_RIGHT_DOWN: return NYA_PAD_KEY_RSTICK_Y_NEG;
